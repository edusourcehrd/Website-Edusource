...
import {
  ...
  usePortal,
  useToast
} from "./chunk-F4KBLQLE.js";
import {
  require_compiler_runtime
} from "./chunk-LBIE3GXR.js";
import {
  require_jsx_runtime
} from "./chunk-ZW7FYK5L.js";
import {
  require_react
} from "./chunk-W5NTF7WX.js";
import {
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources8-ZAE57FVR.js")
});
...
function useDiffViewState(t0) {
  ...
  $[26] !== onTargetDocumentsChanged || $[27] !== state2 ? (t12 = () => {
    typeof onTargetDocumentsChanged == "function" && previousState.current?.isActive && state2.isActive && !isEqual_default([previousState?.current?.documents?.previous.id, previousState?.current?.documents?.next.id], [state2.documents?.previous.id, state2.documents?.next.id]) && onTargetDocumentsChanged(previousState.current, state2);
...
var VersionMenuItem = (t0) => {
  ...
  let t9;
  $[33] !== formatPublishDate || $[34] !== release ? (t9 = release.metadata.releaseType === "scheduled" && (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: formatPublishDate(release) }), $[33] = formatPublishDate, $[34] = release, $[35] = t9) : t9 = $[35];
  let t10;
  $[36] !== t7 || $[37] !== t8 || $[38] !== t9 ? (t10 = (0, import_jsx_runtime2.jsxs)(Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, style: t3, children: [
    t7,
    t8,
    t9
  ] }), $[36] = t7, $[37] = t8, $[38] = t9, $[39] = t10) : t10 = $[39];
  let t11;
  $[40] !== release ? (t11 = isReleaseScheduledOrScheduling(release) && (0, import_jsx_runtime2.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(LockIcon, {}) }) }), $[40] = release, $[41] = t11) : t11 = $[41];
  let t12;
  $[42] !== t11 ? (t12 = (0, import_jsx_runtime2.jsx)(Flex, { flex: "none", children: t11 }), $[42] = t11, $[43] = t12) : t12 = $[43];
  let t13;
  $[44] !== t10 || $[45] !== t12 || $[46] !== t2 ? (t13 = (0, import_jsx_runtime2.jsxs)(Flex, { gap: 1, children: [
    t2,
    t10,
    t12
  ] }), $[44] = t10, $[45] = t12, $[46] = t2, $[47] = t13) : t13 = $[47];
  let t14;
  return $[48] !== isSelected || $[49] !== onClick || $[50] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: t13 }), $[48] = isSelected, $[49] = onClick, $[50] = t13, $[51] = t14) : t14 = $[51], t14;
};
...
var Container2 = gt(Container).withConfig({
...
var Pane = (0, import_react2.forwardRef)(function(props, forwardedRef) {
  ...
  if ($[10] !== panes || $[11] !== rootElement) {
    ...
    pane = $[12], t2 = $[13];
  const paneIndex = t2, nextPane = typeof paneIndex == "number" ? panes[paneIndex + 1] : void 0, isLast = paneIndex === panes.length - 1, expanded = expandedElement === rootElement, collapsed = layoutCollapsed ? false : pane?.collapsed || false, nextCollapsed = nextPane?.collapsed || false, ref = (0, import_react2.useRef)(null), flex = pane?.flex ?? flexProp, currentMinWidth = pane?.currentMinWidth ?? currentMinWidthProp, currentMaxWidth = pane?.currentMaxWidth ?? currentMaxWidthProp;
  let t3;
...
var Root$6 = gt(Layer).withConfig({
  displayName: "Root",
...
var TitleCard = gt(Card).withConfig({
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$G), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
var JSONInspectorWrapper = gt.div.withConfig({
...
function InsufficientPermissionBanner(t0) {
  ...
  let t5;
  $[10] !== requiredPermission || $[11] !== t3 || $[12] !== t32 || $[13] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime2.jsx)(Translate, { t: t3, i18nKey: "banners.permission-check-banner.missing-permission", components: t32, values: t4, context: requiredPermission }) }), $[10] = requiredPermission, $[11] = t3, $[12] = t32, $[13] = t4, $[14] = t5) : t5 = $[14];
  let t6;
  $[15] !== requestPending || $[16] !== setShowRequestPermissionDialog || $[17] !== showAskToEditAction || $[18] !== t3 || $[19] !== telemetry ? (t6 = showAskToEditAction ? {
    onClick: requestPending ? void 0 : () => {
      setShowRequestPermissionDialog(true), telemetry.log(AskToEditDialogOpened);
    },
    text: t3(requestPending ? "banners.permission-check-banner.request-permission-button.sent" : "banners.permission-check-banner.request-permission-button.text"),
    tone: requestPending ? "default" : "primary",
    disabled: requestPending,
    mode: requestPending ? "bleed" : void 0
  } : void 0, $[15] = requestPending, $[16] = setShowRequestPermissionDialog, $[17] = showAskToEditAction, $[18] = t3, $[19] = telemetry, $[20] = t6) : t6 = $[20];
  let t7;
  $[21] !== t5 || $[22] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Banner, { content: t5, action: t6, "data-testid": "permission-check-banner", icon: ReadOnlyIcon }), $[21] = t5, $[22] = t6, $[23] = t7) : t7 = $[23];
  let t8;
  $[24] !== setShowRequestPermissionDialog || $[25] !== showRequestPermissionDialog ? (t8 = showRequestPermissionDialog && (0, import_jsx_runtime2.jsx)(RequestPermissionDialog, { onClose: () => setShowRequestPermissionDialog(false), onRequestSubmitted: () => {
  ...
  let t9;
  return $[27] !== t7 || $[28] !== t8 ? (t9 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t7,
    t8
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$A), $[8] = t22) : t22 = $[8];
...
function ScheduledReleaseBanner(t0) {
  ...
  let t5;
  $[7] !== t4 || $[8] !== tCore ? (t5 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { t: tCore, i18nKey: "release.banner.scheduled-for-publishing-on", values: t4 }) }), $[7] = t4, $[8] = tCore, $[9] = t5) : t5 = $[9];
  let t6;
  return $[10] !== t5 || $[11] !== tone ? (t6 = (0, import_jsx_runtime2.jsx)(Banner, { tone, icon: LockIcon, content: t5 }), $[10] = t5, $[11] = tone, $[12] = t6) : t6 = $[12], t6;
}
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_compiler_runtime2.c)(78), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$z), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
...
var DocumentBox = gt(Box).withConfig({
  displayName: "DocumentBox",
  componentId: "sc-10i0hcs-0"
})({
  position: "relative"
});
var Scroller$4 = gt(ScrollContainer).withConfig({
  displayName: "Scroller",
...
var DocumentPanel = function(props) {
  ...
  bb1: {
    if (params?.historyVersion) {
      let t123;
      $[35] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t123 = (0, import_jsx_runtime2.jsx)(ArchivedReleaseDocumentBanner, {}), $[35] = t123) : t123 = $[35], t11 = t123;
      break bb1;
    }
    let t122;
    ...
    if (isPausedDraft && displayed?._id) {
      let t143;
      $[49] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t143 = (0, import_jsx_runtime2.jsx)(PausedScheduledDraftBanner, {}), $[49] = t143) : t143 = $[49], t11 = t143;
      break bb1;
    }
...
function NonReleaseVersionsSelect(props) {
  ...
  $[7] !== documentType || $[8] !== getVersionDisplay || $[9] !== onCopyToDraftsNavigate || $[10] !== onSelectBundle || $[11] !== releases || $[12] !== releasesLoading || $[13] !== selectedNonReleaseVersion ? (t4 = selectedNonReleaseVersion && (() => {
    ...
    return (0, import_jsx_runtime2.jsx)(VersionChip$1, { selected: true, text: versionDisplay?.displayName ?? bundleId, tone: versionDisplay?.tone ?? "default", onClick: () => onSelectBundle(bundleId), onCopyToDraftsNavigate, contextValues: {
  ...
  if ($[19] !== documentType || $[20] !== getVersionDisplay || $[21] !== onCopyToDraftsNavigate || $[22] !== onSelectBundle || $[23] !== otherNonReleaseVersions || $[24] !== releases || $[25] !== releasesLoading || $[26] !== selectedPerspective) {
    ...
    $[28] !== documentType || $[29] !== getVersionDisplay || $[30] !== onCopyToDraftsNavigate || $[31] !== onSelectBundle || $[32] !== releases || $[33] !== releasesLoading || $[34] !== selectedPerspective ? (t72 = (nonReleaseVersionId) => {
      ...
      return (0, import_jsx_runtime2.jsx)(VersionChip$1, { selected, text: versionDisplay_0?.displayName ?? bundle, disabled: false, contextMenuPortal: false, tone: versionDisplay_0?.tone ?? "default", onClick: () => onSelectBundle(bundle), onCopyToDraftsNavigate, contextValues: {
...
var TooltipContent$1 = (t0) => {
  ...
  if (release.metadata.releaseType === "scheduled") {
    ...
    let t1;
    return $[8] !== formatPublishDate || $[9] !== isActive || $[10] !== release || $[11] !== t2 ? (t1 = release.metadata.intendedPublishAt && (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: isActive ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.intended-for-date", values: {
      ...
      date: formatPublishDate(release)
    } }) }), $[8] = formatPublishDate, $[9] = isActive, $[10] = release, $[11] = t2, $[12] = t1) : t1 = $[12], t1;
  }
  if (release.metadata.releaseType === "undecided") {
    let t1;
    $[13] !== t2 ? (t1 = t2("release.type.undecided"), $[13] = t2, $[14] = t1) : t1 = $[14];
    let t22;
    return $[15] !== t1 ? (t22 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: t1 }), $[15] = t1, $[16] = t22) : t22 = $[16], t22;
  }
  return null;
};
...
var HorizontalScroller = gt(Card).withConfig({
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  ...
  } = useFieldActions(), [referenceElement, setReferenceElement] = (0, import_react2.useState)(null), scrollContainerRef = (0, import_react2.useRef)(null), showGradient = useChipScrollPosition(scrollContainerRef), telemetry = useTelemetry(), zIndex = useZIndex(), paneHeaderZIndex = Array.isArray(zIndex.paneHeader) ? zIndex.paneHeader[1] : zIndex.paneHeader;
  let t0;
  ...
  ] }) }) }), $[18] = BackLink2, $[19] = backButton, $[20] = collapsed, $[21] = connectionState, $[22] = contextMenuNodes, $[23] = editState, $[24] = handleFocusPane, $[25] = isMaximizedPane, $[26] = menuButtonNodes, $[27] = onPaneClose, $[28] = onPaneSplit, $[29] = onSetMaximizedPane, $[30] = paneHeaderZIndex, $[31] = ref, $[32] = referenceElement, $[33] = schemaType, $[34] = showGradient, $[35] = showPaneGroupCloseButton, $[36] = showSplitPaneButton, $[37] = showSplitPaneCloseButton, $[38] = t3, $[39] = tabIndex, $[40] = unstable_languageFilter, $[41] = t6) : t6 = $[41], t6;
}));
...
var IconBox = gt(Flex).withConfig({
  displayName: "IconBox",
...
var NameSkeleton = gt(Skeleton).withConfig({
...
var Root$2 = gt(Popover2).withConfig({
  displayName: "Root",
...
function DocumentStatusLine() {
  const $ = (0, import_compiler_runtime2.c)(18), {
    ...
    documentId,
    documentType
  } = useDocumentPaneInfo(), [status, setStatus] = (0, import_react2.useState)(null), eventsEnabled = useSource().beta?.eventsAPI?.documents, syncState = useSyncState(documentId, documentType, editState?.release), lastUpdated = value?._updatedAt;
  let t0;
...
function DocumentStatusBar(props) {
  ...
  if (showingRevision) {
    let t42;
    $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(HistoryStatusBarActions, {}), $[3] = t42) : t42 = $[3], actions = t42;
  } else {
    let t42;
    $[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(DocumentStatusBarActions, {}), $[4] = t42) : t42 = $[4], actions = t42;
  }
...
var StyledChangeConnectorRoot = gt(ChangeConnectorRoot).withConfig({
...
var DocumentTitle = (t0) => {
  ...
  let t3;
  $[4] !== isDeleted || $[5] !== isNewDocument2 || $[6] !== schemaType?.name || $[7] !== schemaType?.title || $[8] !== t2 || $[9] !== value?.title ? (t3 = isDeleted ? "" : isNewDocument2 ? t2("browser-document-title.new-document", {
    schemaType: schemaType?.title || schemaType?.name
  }) : value?.title || t2("browser-document-title.untitled-document"), $[4] = isDeleted, $[5] = isNewDocument2, $[6] = schemaType?.name, $[7] = schemaType?.title, $[8] = t2, $[9] = value?.title, $[10] = t3) : t3 = $[10];
...
var StructureTitle = (props) => {
  ...
  if (isLoadingPane(lastPane)) {
    let t02;
    return $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(PassthroughTitle, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
var useDeletedDocumentLastRevision = () => {
  const $ = (0, import_compiler_runtime2.c)(3), {
    revision
  } = (0, import_react2.useContext)(EventsContext) || EventsContextFallback, t0 = revision?.document || null, t1 = revision?.loading || false;
  let t2;
  return $[0] !== t0 || $[1] !== t1 ? (t2 = {
...
function useDocumentInitialLoadTelemetry(t0) {
  const $ = (0, import_compiler_runtime2.c)(9), {
    ...
    editState,
    hasRevisionParam
  } = t0, telemetry = useTelemetry(), t0Ref = (0, import_react2.useRef)(null);
  let t1, t2;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = () => {
    t0Ref.current = performance.now();
  }, t2 = [], $[0] = t1, $[1] = t2) : (t1 = $[0], t2 = $[1]), (0, import_react2.useEffect)(t1, t2);
  ...
  $[2] !== editState || $[3] !== hasRevisionParam || $[4] !== ready || $[5] !== schemaTypeName || $[6] !== telemetry ? (t3 = () => {
    ...
    const isNewDoc = editState?.ready === true && editState.draft === null && editState.published === null && editState.version === null;
  ...
  }, t4 = [ready, telemetry, schemaTypeName, editState, hasRevisionParam], $[2] = editState, $[3] = hasRevisionParam, $[4] = ready, $[5] = schemaTypeName, $[6] = telemetry, $[7] = t3, $[8] = t4) : (t3 = $[7], t4 = $[8]), (0, import_react2.useEffect)(t3, t4);
}
...
function DocumentPaneProvider(props) {
  const $ = (0, import_compiler_runtime2.c)(250), {
    children,
    index,
    pane,
    paneKey,
  ...
  let t15;
  $[17] !== isPristine || $[18] !== timelineReady ? (t15 = (editState) => timelineReady ? !editState?.draft && !editState?.published && !editState?.version && !isPristine : false, $[17] = isPristine, $[18] = timelineReady, $[19] = t15) : t15 = $[19];
  ...
  }), true) : item.action === "toggleInlineChanges" ? (toggleInlineChanges(), true) : false), $[108] = diffViewRouter, $[109] = documentType, $[110] = handleHistoryOpen, $[111] = handleInspectorAction, $[112] = previewUrl, $[113] = previousId, $[114] = toggleInlineChanges, $[115] = value_0._id, $[116] = t39) : t39 = $[116];
  ...
  }, t41 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[117] = documentId, $[118] = documentType, $[119] = onChange, $[120] = schemaType, $[121] = setDocumentMeta, $[122] = t40, $[123] = t41) : (t40 = $[122], t41 = $[123]), (0, import_react2.useEffect)(t40, t41);
  let t42;
  ...
  $[129] !== actions || $[130] !== activeViewId || $[131] !== badges || $[132] !== changesOpen || $[133] !== closeInspector || $[134] !== collapsedFieldSets || $[135] !== collapsedPaths || $[136] !== compareValue || $[137] !== connectionState || $[138] !== currentDisplayed || $[139] !== documentId || $[140] !== documentIdRaw || $[141] !== documentType || $[142] !== editState_1 || $[143] !== fieldActions || $[144] !== focusPath || $[145] !== formState || $[146] !== handleHistoryClose || $[147] !== handleHistoryOpen || $[148] !== handleLegacyInspectClose || $[149] !== handleMenuAction || $[150] !== handlePaneClose || $[151] !== handlePaneSplit || $[152] !== handlePathOpen || $[153] !== hasUpstreamVersion || $[154] !== index || $[155] !== inspectOpen || $[156] !== inspectors2 || $[157] !== isDeleted_1 || $[158] !== isDeleting || $[159] !== isInitialValueLoading || $[160] !== isPermissionsLoading || $[161] !== languageFilter || $[162] !== lastNonDeletedRevId || $[163] !== lastRevisionDocument || $[164] !== maximized || $[165] !== onBlur || $[166] !== onChange || $[167] !== onFocus || $[168] !== onSetActiveFieldGroup || $[169] !== onSetCollapsedFieldSet || $[170] !== onSetCollapsedPath || $[171] !== onSetMaximizedPane || $[172] !== openInspector || $[173] !== openPath || $[174] !== paneKey || $[175] !== permissions || $[176] !== previewUrl || $[177] !== ready || $[178] !== revisionId || $[179] !== revisionNotFound || $[180] !== schemaType || $[181] !== selectedReleaseId || $[182] !== setTimelineRange || $[183] !== t44 || $[184] !== t45 || $[185] !== timelineError || $[186] !== timelineStore || $[187] !== title || $[188] !== validation || $[189] !== value_0 || $[190] !== views2 ? (t46 = {
    ...
    lastNonDeletedRevId,
    lastRevisionDocument
  }, $[129] = actions, $[130] = activeViewId, $[131] = badges, $[132] = changesOpen, $[133] = closeInspector, $[134] = collapsedFieldSets, $[135] = collapsedPaths, $[136] = compareValue, $[137] = connectionState, $[138] = currentDisplayed, $[139] = documentId, $[140] = documentIdRaw, $[141] = documentType, $[142] = editState_1, $[143] = fieldActions, $[144] = focusPath, $[145] = formState, $[146] = handleHistoryClose, $[147] = handleHistoryOpen, $[148] = handleLegacyInspectClose, $[149] = handleMenuAction, $[150] = handlePaneClose, $[151] = handlePaneSplit, $[152] = handlePathOpen, $[153] = hasUpstreamVersion, $[154] = index, $[155] = inspectOpen, $[156] = inspectors2, $[157] = isDeleted_1, $[158] = isDeleting, $[159] = isInitialValueLoading, $[160] = isPermissionsLoading, $[161] = languageFilter, $[162] = lastNonDeletedRevId, $[163] = lastRevisionDocument, $[164] = maximized, $[165] = onBlur, $[166] = onChange, $[167] = onFocus, $[168] = onSetActiveFieldGroup, $[169] = onSetCollapsedFieldSet, $[170] = onSetCollapsedPath, $[171] = onSetMaximizedPane, $[172] = openInspector, $[173] = openPath, $[174] = paneKey, $[175] = permissions, $[176] = previewUrl, $[177] = ready, $[178] = revisionId, $[179] = revisionNotFound, $[180] = schemaType, $[181] = selectedReleaseId, $[182] = setTimelineRange, $[183] = t44, $[184] = t45, $[185] = timelineError, $[186] = timelineStore, $[187] = title, $[188] = validation, $[189] = value_0, $[190] = views2, $[191] = t46) : t46 = $[191];
  const documentPane = t46;
  let t47;
  $[192] !== menuItemGroups ? (t47 = menuItemGroups || [], $[192] = menuItemGroups, $[193] = t47) : t47 = $[193];
  let t48;
  $[194] !== actions || $[195] !== badges || $[196] !== documentId || $[197] !== documentIdRaw || $[198] !== documentType || $[199] !== fieldActions || $[200] !== handlePaneClose || $[201] !== handlePaneSplit || $[202] !== index || $[203] !== languageFilter || $[204] !== maximized || $[205] !== onSetMaximizedPane || $[206] !== paneKey || $[207] !== schemaType || $[208] !== t47 || $[209] !== title || $[210] !== views2 ? (t48 = {
    actions,
    badges,
    documentId,
    documentIdRaw,
    ...
    views: views2,
    unstable_languageFilter: languageFilter
  }, $[194] = actions, $[195] = badges, $[196] = documentId, $[197] = documentIdRaw, $[198] = documentType, $[199] = fieldActions, $[200] = handlePaneClose, $[201] = handlePaneSplit, $[202] = index, $[203] = languageFilter, $[204] = maximized, $[205] = onSetMaximizedPane, $[206] = paneKey, $[207] = schemaType, $[208] = t47, $[209] = title, $[210] = views2, $[211] = t48) : t48 = $[211];
  const documentPaneInfo = t48, pathRef = (0, import_react2.useRef)(void 0), paramPath = params.path;
  let t49;
  ...
  const syncPathFromUrl = (0, import_react2.useEffectEvent)(t49);
  let t50;
  ...
  let t51;
  $[220] !== paramPath || $[221] !== ready ? (t51 = [paramPath, ready], $[220] = paramPath, $[221] = ready, $[222] = t51) : t51 = $[222], (0, import_react2.useEffect)(t50, t51);
  ...
  let t53;
  $[230] !== onProgrammaticFocus ? (t53 = (0, import_jsx_runtime2.jsx)(DivergenceAutofocus, { onProgrammaticFocus }), $[230] = onProgrammaticFocus, $[231] = t53) : t53 = $[231];
  let t54;
  $[232] !== displayed || $[233] !== isDeleted_1 || $[234] !== ready || $[235] !== schemaType ? (t54 = (0, import_jsx_runtime2.jsx)(DocumentTitle, { isDeleted: isDeleted_1, displayed, ready, schemaType }), $[232] = displayed, $[233] = isDeleted_1, $[234] = ready, $[235] = schemaType, $[236] = t54) : t54 = $[236];
  let t55;
  $[237] !== children ? (t55 = (0, import_jsx_runtime2.jsx)(ParseErrorsProvider, { children }), $[237] = children, $[238] = t55) : t55 = $[238];
  let t56;
  $[239] !== divergencesProps || $[240] !== t53 || $[241] !== t54 || $[242] !== t55 ? (t56 = (0, import_jsx_runtime2.jsxs)(DivergencesProvider, { ...divergencesProps, children: [
    t53,
    t54,
    t55
  ] }), $[239] = divergencesProps, $[240] = t53, $[241] = t54, $[242] = t55, $[243] = t56) : t56 = $[243];
  let t57;
  $[244] !== documentPane || $[245] !== t56 ? (t57 = (0, import_jsx_runtime2.jsx)(DocumentPaneContext.Provider, { value: documentPane, children: t56 }), $[244] = documentPane, $[245] = t56, $[246] = t57) : t57 = $[246];
  let t58;
  return $[247] !== documentPaneInfo || $[248] !== t57 ? (t58 = (0, import_jsx_runtime2.jsx)(DocumentPaneInfoContext.Provider, { value: documentPaneInfo, children: t57 }), $[247] = documentPaneInfo, $[248] = t57, $[249] = t58) : t58 = $[249], t58;
}
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./index2-XT2NKZQW.js")),
  document: (0, import_react2.lazy)(() => import("./pane-5KIE3JEJ.js")),
  documentList: (0, import_react2.lazy)(() => import("./pane2-2GJAPZEG.js")),
  list: (0, import_react2.lazy)(() => import("./index3-KFZXREEY.js"))
};
...
var VersionItemPreview = (t0) => {
  ...
  let t11;
  $[27] !== documentVariant || $[28] !== release?.metadata?.title || $[29] !== systemTitle || $[30] !== versionId ? (t11 = documentVariant === "version" ? (0, import_jsx_runtime2.jsx)(ReleaseTitle, { title: release?.metadata?.title, fallback: getVersionFromId(versionId), children: _temp$g }) : (0, import_jsx_runtime2.jsx)(EllipsisText, { size: 1, weight: "medium", textOverflow: "ellipsis", children: systemTitle }), $[27] = documentVariant, $[28] = release?.metadata?.title, $[29] = systemTitle, $[30] = versionId, $[31] = t11) : t11 = $[31];
  let t12;
...
function PaneHeaderCreateButton(t0) {
  ...
  const [templatePermissions, isTemplatePermissionsLoading] = useTemplatePermissions(t22), nothingGranted = !isTemplatePermissionsLoading && templatePermissions?.length !== 0 && templatePermissions?.every(_temp$d);
  let t3;
  bb0: {
  ...
  return menuItems?.map((item) => {
    ...
    if (item?.params?.by) {
      const itemSortOrder = {
        ...
        by: sortOrderRaw?.by ?? EMPTY_ARRAY$y
      }).by, itemSortBy = toStaticSortOrder({
        by: item?.params?.by ?? EMPTY_ARRAY$y
      }).by;
      return {
        ...item,
        selected: isEqual_default(staticSortBy, itemSortBy),
        ...isInvalidSortOrder && {
          disabled: {
...
var PaneContainer = (0, import_react2.memo)(function(props) {
  ...
  let t62;
  $[8] !== schemaType || $[9] !== storedSortOrderRaw ? (t62 = fromStaticSortOrder(storedSortOrderRaw, schemaType), $[8] = schemaType, $[9] = storedSortOrderRaw, $[10] = t62) : t62 = $[10];
  const sortOrderRaw = t62;
  let t7;
  bb1: {
    if (!sortOrderRaw) {
      t7 = sortOrderRaw;
  ...
  const [customMenuItemState, setCustomMenuItemState] = (0, import_react2.useState)(t9);
  let t10;
  $[20] !== menuItems ? (t10 = addIdsToMenuItems(menuItems), $[20] = menuItems, $[21] = t10) : t10 = $[21];
  const menuItemsWithIds = t10;
  let t11;
  $[22] !== t6 ? (t11 = t6("panes.document-list-pane.sort-order.disabled-reason"), $[22] = t6, $[23] = t11) : t11 = $[23];
  ...
  let t15;
  $[33] !== customMenuItemState || $[34] !== handleSetSortOrder || $[35] !== index || $[36] !== initialValueTemplates || $[37] !== menuItemGroups || $[38] !== menuItemsWithSelectedState || $[39] !== setLayout || $[40] !== title ? (t15 = (0, import_jsx_runtime2.jsx)(PaneHeader, { customMenuItemState, index, initialValueTemplates, menuItemGroups, menuItems: menuItemsWithSelectedState, setLayout, setSortOrder: handleSetSortOrder, setCustomMenuItemState, title }), $[33] = customMenuItemState, $[34] = handleSetSortOrder, $[35] = index, $[36] = initialValueTemplates, $[37] = menuItemGroups, $[38] = menuItemsWithSelectedState, $[39] = setLayout, $[40] = title, $[41] = t15) : t15 = $[41];
  let t16;
  $[42] !== layout || $[43] !== props || $[44] !== validatedSortOrder ? (t16 = (0, import_jsx_runtime2.jsx)(DocumentListPane, { ...props, sortOrder: validatedSortOrder, layout }), $[42] = layout, $[43] = props, $[44] = validatedSortOrder, $[45] = t16) : t16 = $[45];
  let t17;
  $[46] !== isSelected || $[47] !== paneKey || $[48] !== t14 || $[49] !== t15 || $[50] !== t16 ? (t17 = (0, import_jsx_runtime2.jsxs)(Pane, { "data-ui": "DocumentListPane", id: paneKey, minWidth: 320, currentMaxWidth: 350, maxWidth: 640, selected: isSelected, children: [
    t14,
    t15,
    t16
  ] }), $[46] = isSelected, $[47] = paneKey, $[48] = t14, $[49] = t15, $[50] = t16, $[51] = t17) : t17 = $[51];
  let t18;
  return $[52] !== t13 || $[53] !== t17 ? (t18 = (0, import_jsx_runtime2.jsx)(SourceProvider, { name: t13, children: t17 }), $[52] = t13, $[53] = t17, $[54] = t18) : t18 = $[54], t18;
});
...
var Root = gt(Popover2).withConfig({
  displayName: "Root",
...
function IncomingReferencesList() {
  ...
  let t5;
  $[15] !== emptyMessage || $[16] !== references?.list || $[17] !== references?.loading || $[18] !== renderSameDatasetItem || $[19] !== t2 ? (t5 = references?.loading ? (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true, title: t2("incoming-references-input.types-loading") }) : references?.list.map((t62) => {
    const {
      type: type_3,
  ...
  }), $[15] = emptyMessage, $[16] = references?.list, $[17] = references?.loading, $[18] = renderSameDatasetItem, $[19] = t2, $[20] = t5) : t5 = $[20];
  let t6;
  $[21] !== crossDatasetRefs?.list || $[22] !== crossDatasetRefs?.loading || $[23] !== emptyMessage || $[24] !== t2 ? (t6 = crossDatasetRefs?.loading ? (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true, title: t2("incoming-references-input.types-loading-cross-dataset") }) : crossDatasetRefs?.list.map((t72) => {
    const {
      type: type_4,
  ...
  }), $[21] = crossDatasetRefs?.list, $[22] = crossDatasetRefs?.loading, $[23] = emptyMessage, $[24] = t2, $[25] = t6) : t6 = $[25];
  let t7;
...
function ValidationInspector(props) {
  ...
  const handleOpen = t1;
  let t22;
  $[6] !== editState ? (t22 = editState && editState.version && isGoingToUnpublish(editState.version), $[6] = editState, $[7] = t22) : t22 = $[7];
  const isVersionGoingToUnpublish = t22;
  let t3;
  $[8] !== t2 ? (t3 = t2("panel.close-button-aria-label"), $[8] = t2, $[9] = t3) : t3 = $[9];
  let t4;
  $[10] !== t2 ? (t4 = t2("panel.title"), $[10] = t2, $[11] = t4) : t4 = $[11];
  let t5;
  $[12] !== onClose || $[13] !== t3 || $[14] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(DocumentInspectorHeader, { as: "header", closeButtonLabel: t3, flex: "none", onClose, title: t4 }), $[12] = onClose, $[13] = t3, $[14] = t4, $[15] = t5) : t5 = $[15];
  let t6;
  $[16] !== handleOpen || $[17] !== isVersionGoingToUnpublish || $[18] !== mergedValidation || $[19] !== schemaType || $[20] !== t2 || $[21] !== value ? (t6 = (0, import_jsx_runtime2.jsx)(Card, { flex: 1, overflow: "auto", padding: 3, children: isVersionGoingToUnpublish ? (0, import_jsx_runtime2.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: t2("panel.unpublish-message") }) }) : (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    mergedValidation.length === 0 && (0, import_jsx_runtime2.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: t2("panel.no-errors-message") }) }),
    mergedValidation.length > 0 && (0, import_jsx_runtime2.jsx)(Stack, { space: 2, children: mergedValidation.map((marker, i) => (0, import_jsx_runtime2.jsx)(ValidationCard, { marker, onOpen: handleOpen, schemaType, value }, i)) })
  ] }) }), $[16] = handleOpen, $[17] = isVersionGoingToUnpublish, $[18] = mergedValidation, $[19] = schemaType, $[20] = t2, $[21] = value, $[22] = t6) : t6 = $[22];
  let t7;
  return $[23] !== t5 || $[24] !== t6 ? (t7 = (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", height: "fill", overflow: "hidden", children: [
    t5,
    t6
...
function useMenuItem(props) {
  ...
  let t5;
  $[5] !== t2 ? (t5 = t2("panel.title"), $[5] = t2, $[6] = t5) : t5 = $[6];
  let t6;
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index4-QS4HFM2C.js")),
...
//# sourceMappingURL=chunk-XJTNOUEQ.js.map
