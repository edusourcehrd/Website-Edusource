...
export default function CourseDetailClient({ slug, initialCourse }: CourseDetailClientProps) {
  ...
  const courseIcon = course.isSanity ? GraduationCap : (course.icon || GraduationCap);
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-20">
          <motion.div 
            ...
            className={`absolute inset-0 bg-gradient-to-br ${course.visualTheme?.gradient || "from-blue-600 to-indigo-700"} z-0`}
          />
          {/* Decorative Elements */}
        ...
        <section className="py-24 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal>
              <div className={`rounded-[40px] sm:rounded-[60px] bg-gradient-to-br ${course.visualTheme?.gradient || "from-blue-600 to-indigo-700"} p-8 sm:p-16 md:p-24 text-center relative overflow-hidden shadow-2xl shadow-blue-500/20`}>
